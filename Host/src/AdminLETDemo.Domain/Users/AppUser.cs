...
namespace AdminLETDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AdminLETDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AdminLETDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
